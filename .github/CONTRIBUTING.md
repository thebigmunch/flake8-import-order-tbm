...
[Issue Tracker](https://github.com/thebigmunch/flake8-import-order-tbm/issues).
...
See the [commit log](https://github.com/thebigmunch/flake8-import-order-tbm/commits) for acceptable examples.
